                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        DatePickerDialog datePickerDialogkt = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                                ...
                                list.clear();
                                list = chucnangthuchi.LocLoaiKhoantheongay(1, ngaydau, ngaysau);
                                if (list.size() != 0 ) {
                    ...
                    public void onClick(View v) {
                        ...
                        if (list.size() != 0 ) {
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    progressDialog.dismiss();
                                    adapter = new KhoanChiAdapter(getContext(), R.layout.listview_item, list);
                                    rcv.setAdapter(adapter);
                                    Toast.makeText(getActivity(), "Lọc thành công!", Toast.LENGTH_SHORT).show();
                                }
                            },1000);
            ...
            public void onClick(View v) {
                ...
                them.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        list.clear();
                        list = chucnangthuchi.Timkiem(1, themText);
                        if (list.size() != 0 ) {
